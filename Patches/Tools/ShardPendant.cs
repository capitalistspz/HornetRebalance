...
public static class ShardPendant
{
    ...
    [HarmonyPatch(typeof(HealthManager), nameof(HealthManager.Die), typeof(float?), typeof(AttackTypes),
        typeof(NailElements), typeof(GameObject), typeof(bool), typeof(float), typeof(bool), typeof(bool))]
    [HarmonyPrefix]
    private static void BossesDropShards(HealthManager __instance, bool overrideSpecialDeath)
    {
